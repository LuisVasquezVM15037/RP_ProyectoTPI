...
if ($es_busqueda) {
    ...
    $sql = "SELECT p.* FROM producto p 
            ...
            WHERE c.nombre_categoria = 'Guantes'
    ...
    // Obtener el total de productos de Guantes
...
<head>
    ...
    <title>Guantes - Jardinería</title>
                ...
                <form method="POST" action="" id="searchForm" class="d-inline">
                    <div class="search-container">
                        <input type="text" class="search-input" name="termino" id="searchInput" 
                               placeholder="Buscar en todas las Guantes..." 
...
<!-- Sección de usuario -->
    ...
    <main class="flex-grow-1 container-fluid px-4 py-5">
        <h2 class="display-4 fw-bold text-center mb-5 text-text-light">Guantes</h2>
        ...
        <div class="contenedor-principal">
            ...
            <?php if ($es_busqueda): ?>
                ...
                <div class="resultado-busqueda">
                    ...
                    <p class="mb-0">Se encontraron <strong><?php echo $total_productos; ?></strong> Guantes</p>
                    <a href="?" class="btn btn-sm btn-primary-custom mt-2">
                        <i class="bi bi-arrow-left"></i> Volver a todas las Guantes
                    </a>
                </div>
            <?php endif; ?>
            ...
            <div class="search-loading" id="searchLoading">
                ...
                <p class="mt-2">Buscando Guantes...</p>
            </div>

            <!-- Contenedor de productos -->
            <div class="row g-4" id="productos-container">
                <?php if (count($Guantes) > 0): ?>
                    <?php foreach ($Guantes as $pala): ?>
                ...
                <?php else: ?>
                    <div class="col-12 text-center py-5">
                        <div class="alert alert-warning">
                            <h4><i class="bi bi-exclamation-triangle"></i> No se encontraron Guantes</h4>
                            <?php if ($es_busqueda): ?>
                                <p>No hay Guantes que coincidan con "<?php echo htmlspecialchars($termino_busqueda); ?>"</p>
                                <a href="?" class="btn btn-primary-custom">Ver todas las Guantes</a>
                            <?php else: ?>
                                <p>No hay Guantes disponibles en este momento.</p>
                            <?php endif; ?>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <div class="paginacion-container mt-5">
                ...
                <div class="paginacion-info">
                    ...
                    <div class="paginacion-numeros">
                        Mostrando <?php echo $inicio_rango; ?>-<?php echo $fin_rango; ?> de <?php echo $total_productos; ?> Guantes
                    </div>
                </div>
